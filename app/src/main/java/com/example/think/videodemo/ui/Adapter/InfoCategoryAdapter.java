...
public class InfoCategoryAdapter extends RecyclerView.Adapter<InfoCategoryAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public InfoCategoryAdapter(Context mContext, List<JokeBean.Result.JokeItem> jokeItemList){
        this.jokeItemList = jokeItemList;
    }

    @NonNull
    @Override
    public InfoCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull InfoCategoryAdapter.ViewHolder viewHolder, int i) {
